  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900 p-4">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-gradient-to-br from-blue-900/40 to-cyan-900/40 rounded-full blur-3xl opacity-50"></div>
      </div>
        ...
        <div className="bg-gray-800/60 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-700 p-8 relative overflow-hidden">
          <div className="relative z-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 text-sm">Masuk untuk mengakses akun Anda</p>
            </div>

            {/* Error message */}
            {error && (
              <div className="mb-6 p-3 bg-red-500/10 text-red-300 text-sm rounded-xl border border-red-500/20">
                {error}
              </div>
            )}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-4 py-3 rounded-xl border border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-200 bg-gray-700/50 text-white placeholder-gray-400"
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-12 py-3 rounded-xl border border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-all duration-200 bg-gray-700/50 text-white placeholder-gray-400"
                    placeholder="••••••••"
                  />
              ...
              <div className="flex items-center justify-between text-sm">
                <label className="flex items-center space-x-2 text-gray-300 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 text-blue-500 bg-gray-600 border-gray-500 rounded focus:ring-blue-500" />
                  <span>Ingat saya</span>
                </label>
                <Link to="/forgot-password" className="text-blue-400 hover:text-blue-300 font-medium transition-colors">Lupa password?</Link>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-gray-400">
                Belum punya akun?{' '}
                <Link to={'/register'} className="font-semibold text-yellow-400 hover:text-yellow-300 transition-colors">Daftar disini</Link>
              </p>
            </div>
          </div>
        </div>
