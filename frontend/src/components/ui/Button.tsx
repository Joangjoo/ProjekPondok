...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    outline: 'border border-green-800 text-green-800 hover:bg-green-50 focus:ring-green-400',
  ...
  return (
    <button
      className={`${baseStyle} ${variantStyles[variant]} ${sizeStyles[size]} ${loadingClass} ${className}`}
