        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1 lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-300">
              Pusat pembelajaran ilmu agama Islam yang berkualitas dengan metode pengajaran yang modern 
              dan pengajar yang berpengalaman.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="text-lg font-medium mb-4 text-amber-400">Tautan Cepat</h3>
          ...
          {/* Programs */}
          <div>
            <h3 className="text-lg font-medium mb-4 text-amber-400">Program Kami</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/courses" className="text-sm text-gray-300 hover:text-white transition-colors">
                  Kursus Al-Quran
          ...
          {/* Contact */}
          <div>
            <h3 className="text-lg font-medium mb-4 text-amber-400">Hubungi Kami</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-2 text-amber-400 mt-0.5" />
                <span className="text-sm text-gray-300">
                  Jl. Islamic Center No. 123, Jakarta Selatan, Indonesia
                </span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-sm text-gray-300">info@pondoksanad.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-green-800 mt-10 pt-6">
          <div className="flex flex-col md:flex-row md:justify-between">
            <p className="text-sm text-gray-400">
              &copy; {new Date().getFullYear()} Pondok Sanad. All rights reserved.
            </p>
